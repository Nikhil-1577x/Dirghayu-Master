...
import { uploadBiomarkerOcr, getBiomarkerNarrative, analyzeReport } from '../api/endpoints';
...
export default function Reports() {
    ...
    const handleFileSelect = async (e: React.ChangeEvent<HTMLInputElement>) => {
        ...
        try {
            ...
            const preview = await analyzeReport(file, patientId);
            ...
            // Keep extracted biomarker cards tied to THIS upload preview only.
            // Do not replace with historical latest-by-type values from prior reports.
