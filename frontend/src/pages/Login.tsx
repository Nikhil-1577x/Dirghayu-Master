...
const ROLES: {
...
}[] = [
    {
        ...
        icon: Heart,
        imageUrl: 'https://images.unsplash.com/photo-1576765608535-5f04d1e3f289?q=80&w=2078&auto=format&fit=crop',
        path: '/caretaker',
    },
    {
        key: 'doctor',
    ...
    },
    {
        ...
        icon: Users,
        imageUrl: 'https://images.unsplash.com/photo-1631815588090-d4bfec5b1ccb?q=80&w=2072&auto=format&fit=crop',
        path: '/cho',
    },
];
...
export default function Login() {
    ...
    const select = (key: UserRole, path: string) => {
        setRole(key);
        navigate(path);
    };
        ...
        >
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 14, marginBottom: 8, position: 'relative', zIndex: 1 }}>
                ...
                <div>
                    ...
                    <div style={{ fontSize: 12, color: '#64748b', fontWeight: 500, letterSpacing: '0.06em', textTransform: 'uppercase' }}>
                        NCD Care Platform
                    </div>
                </div>
            </div>

            <p style={{ fontSize: 16, color: '#94a3b8', marginBottom: 48, textAlign: 'center', position: 'relative', zIndex: 1 }}>
                    ...
                    return (
                        <button
                            ...
                            style={{
                                ...
                                boxShadow: `0 4px 40px rgba(${r.themeColorRGB}, 0.15), 0 0 0 1px rgba(0,0,0,0.04)`,
                            }}
                            onMouseEnter={(e) => {
                                e.currentTarget.style.transform = 'translateY(-8px) scale(1.02)';
                                e.currentTarget.style.boxShadow = `0 20px 60px rgba(${r.themeColorRGB}, 0.3), 0 0 0 1px rgba(0,0,0,0.06)`;
                                const img = e.currentTarget.querySelector('.card-bg') as HTMLElement;
                                if (img) img.style.transform = 'scale(1.08)';
                                const btn = e.currentTarget.querySelector('.card-cta') as HTMLElement;
                                if (btn) {
                            ...
                            onMouseLeave={(e) => {
                                ...
                                e.currentTarget.style.boxShadow = `0 4px 40px rgba(${r.themeColorRGB}, 0.15), 0 0 0 1px rgba(0,0,0,0.04)`;
                                const img = e.currentTarget.querySelector('.card-bg') as HTMLElement;
